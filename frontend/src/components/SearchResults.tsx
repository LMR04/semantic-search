            ...
            <Card key={doc.id} className="p-6 hover:shadow-md transition-shadow duration-200">
              <div className="space-y-3">
                ...
                <div className="flex items-center space-x-4 text-xs text-muted-foreground">
                  ...
                  <div className="flex items-center space-x-1">
                    <span>Precision: {(doc.score * 100).toFixed(0)}%</span>
                  </div>
                </div>
              </div>
            </Card>
...
// import { useState } from "react";
// import { FileText, FileSpreadsheet, File, ExternalLink, Calendar, Upload } from "lucide-react";
// import { Card } from "@/components/ui/card";
// import { Button } from "@/components/ui/button";
// import { Badge } from "@/components/ui/badge";
// import DocumentViewer from "./DocumentViewer";
...
//           <div className="flex items-center justify-between">
//             <p className="text-sm text-muted-foreground">
//               Mostrando {results.length} documento{results.length !== 1 ? 's' : ''} disponibles
//             </p>
//           </div>
//         )}
...
//                   <div className="flex items-center space-x-1">
//                     <span>Relevancia: {formatScore(doc.score)}%</span>
//                   </div>
                  
//                   {doc.weight && (
//                     <div className="flex items-center space-x-1">
//                       <span>Peso: {doc.weight}</span>
//                     </div>
//                   )}
//                 </div>
//               </div>
