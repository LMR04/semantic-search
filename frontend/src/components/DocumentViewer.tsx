            ...
            <Document
              ...
              error={
                <div className="text-red-500 p-4">
                  Error al cargar el PDF. Intenta descargarlo directamente.
                </div>
              }
            >
              <Page 
            ...
            <div className="text-center space-y-4">
              ...
              <div>
                <h3 className="text-lg font-medium">
                  {normalizedType.includes('xls') ? 'Hoja de Cálculo' : 'Documento de Word'}
                </h3>
          ...
          <Card className="p-6">
            <div className="text-center space-y-4">
              ...
              <div>
                <h3 className="text-lg font-medium">Archivo no compatible</h3>
                <p className="text-sm text-muted-foreground mt-2">
                  No se puede previsualizar este tipo de archivo ({document.type})
                </p>
                <Button 
                  className="mt-4" 
                  onClick={() => window.open(document.url, '_blank')}
